...
//			'condition' => "
//			`date_add`>=$timestampStart AND `date_add`<$timestampEnd" . $clientCond . $userCond.
//			" AND `status`='success'
//				AND `type`='in'
//				AND `client_id` <> 0
//				AND `user_id` <> 0 "
...
//	}
	 ...
	 * @return self[]
	 */
//	public static function getModels($timestampStart=0, $timestampEnd=0, $userId = 0, $clientId = 0, $walletId = 0)
//	{
...
//
//		if($walletId)
//			$walletCond = " AND `merchant_wallet_id`=$walletId ";
//
...
//	}
	 ...
	 *
	 */
//	public static function managerStats($dateFrom, $dateTo, $userId)
//	{
//		$result = 0;
//
