...
//		отключение предзагрузки контроллеров чтобы небыло конфликта с именами классов
...
//		'application.modules.card.controllers.*',
		...
		'application.modules.intellectMoney.models.*',
		'application.modules.intellectMoney.controllers.*',
		'application.modules.intellectMoney.views.*',
		'application.modules.intellectMoney.components.*',
		...
		'application.modules.testCard.models.*',
		'application.modules.testCard.views.*',
		'application.modules.testCard.components.*',
