...
$(function () {
    $('.btnDateInterval').on('click', function () {
        $(this).closest("form").find("input.inputDateIntervalFrom").val($(this).attr('valueFrom'));
        $(this).closest("form").find("input.inputDateIntervalTo").val($(this).attr('valueTo'));
