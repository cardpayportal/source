...
<?if($payUrl){?>
	...
	<input class="form-control click2select short" title="" type="text" size="70" value="<?=$payUrl?>" class="click2select">
...
<div class="box box-bordered">
	...
	<div class="box-content">
		<p>
			...
			(<span class="success">оплачено:</span> <b><?=formatAmount($statsYandex['amount'], 0)?></b>)
		</p>
		...
		<form method="post" action="">
			...
			<p>
				...
				<a href="<?=url('manager/yandexPayHistory')?>">
					<button type="button" class="btn btn-blue">Вся история поступлений</button>
				</a>
			</p>
		</form>
