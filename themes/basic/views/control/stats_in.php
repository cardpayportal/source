...
<table class="std padding">
    ...
    <?foreach($result as $id=>$arr1){?>
        <tr>
            <td valign="top"><strong><?=$arr1['name']?></strong></td>
            <td valign="top">
                    ...
                    <table class="std padding">
                        <?foreach($arr1['children'] as $child1){?>
                            <tr>
								...
								<td valign="top"<?=formatAmount($child1['amount'], 0)?></td>
															...
															<?foreach($child2['stats'] as $wallet=>$amount){?>
																<tr>
																	<?if($wallet){?>
																		<td><?=$wallet?></td>
																	<?}?>
																	<td style="text-align: left"><b style="color: green"><?=formatAmount($amount, 0)?></b></td>
																</tr>
															<?}?>
														</table>
                                                    </td>
