 ...
 * @var string $withdrawPriority
 * @var array $withdrawPriorityArr
...
<p>
	...
	<br>
	Курс: <?=config('storeApiBtcRate')?> usd <i>(Bitfinex: <?=$btcRateBitfinex?>)</i>
	<br>
	...
	<table>
		<?if($getWalletsEnabled){?>
			<tr>
				...
				<td><input type="submit" name="switchGetWallets" value="Отключить"></td>
			</tr>
		<?}else{?>
			<tr>
				<td><span class="error">Выдача кошельков отключена</span></td>
				<td><input type="submit" name="switchGetWallets" value="Включить"></td>
			</tr>
		<?}?>
		...
		<?if($withdrawEnabled){?>
			<tr>
				...
				<td><input type="submit" name="switchWithdraw" value="Отключить"></td>
			</tr>
		<?}else{?>
			<tr>
				<td><span class="error">Выводы отключены</span></td>
				<td><input type="submit" name="switchWithdraw" value="Включить"></td>
			</tr>
		<?}?>
		...
		<tr>
			...
			<td>
				<label>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" name="changePriority" value="Сменить">
				</label>
			</td>
		</tr>
