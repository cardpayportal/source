...
<h2>Платежи (<?=count($transactions)?>)</h2>
	...
	<?if($transactions){?>
		...
		<p>
			...
			<b><span class="dotted" title="Уникальных киви-отправителей, киви-получателей(новая комса)">Уникальных кошельков(за сегодня):</span></b> <?=$stats['today_wallets_count']?><br><br>
