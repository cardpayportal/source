	...
	<p>
		<select name="filter[client_id]" class="changeSubmit">
			...
			<?foreach(Client::getActiveClients() as $client){?>
				...
				>
					<?=$client->name?>
					<?$countAccount = SimAccount::getCountByClientId($client->id);?>
...
<form method="post">
	<p>
		<input type="text" name="params[searchStr]" value="<?=$params['searchStr']?>" placeholder="9543456453">
...
<form method="post">
	...
	<p>
		...
		<textarea cols="35" rows="10" name="params[loginStr]"
				  placeholder="9567464636<?="\n"?>9567464637<?="\n"?>9567464638"><?=$params['loginStr']?></textarea>
